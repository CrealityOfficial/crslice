...
#include "cxutil/settings/GCodePathConfig.h"
...
private:
    ...
    std::vector<Ratio> getLineWidthFactorPerExtruder(const LayerIndex& layer_nr);
public:
    ...
    GCodePathConfig slow_flow_travel_config;
    GCodePathConfig flow_in_advance_config;
