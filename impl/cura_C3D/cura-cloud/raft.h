...
public:
     ...
     * layer_0_z_overlap.
     */
    static coord_t getZdiffBetweenRaftAndLayer1(Scene* scene);
     ...
     */
    static size_t getFillerLayerCount(Scene* scene);

    /*!
     * \brief Get the layer height of the filler layers in between the raft and
     * layer 1.
     */
    static coord_t getFillerLayerHeight(Scene* scene);

    /*!
     * \brief Get the total thickness of the raft (without airgap).
     */
    static coord_t getTotalThickness(Scene* scene);
    static coord_t getTotalSimpleRaftThickness(Scene* scene);
    /*!
     ...
     */
    static size_t getTotalExtraLayers(Scene* scene);
    static size_t getTotalSimpleExtraLayers(Scene* scene);
