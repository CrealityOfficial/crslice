...
public:
     ...
     */
    static void getFirstLayerOutline(SliceDataStorage& storage, const size_t primary_line_count, const bool is_skirt, const bool sliceBelt, Polygons& first_layer_outline);
