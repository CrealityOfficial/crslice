...
public:
     ...
     */
    void writeGCode(SliceDataStorage& storage, cxutil::TimeKeeper* timeKeeper);
...
private:
    ...
    */
     ...
     */
    cxutil::optional<Point> getSeamAvoidingLocation(const Polygons& filling_part, int filling_angle, Point last_position) const;
