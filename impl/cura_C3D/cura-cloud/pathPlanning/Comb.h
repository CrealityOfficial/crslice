...
#include "cxutil/settings/LayerIndex.h" //To store the layer on which we comb.
#include "cxutil/util/optional.h"
#include "cxutil/math/polygon.h"
#include "cxutil/util/polygonUtils.h"
#include "cxutil/util/LazyInitialization.h"
...
private:
    ...
    public:
        ...
        cxutil::optional<ConstPolygonPointer> dest_crossing_poly; //!< The polygon of the part in which dest_point lies, which will be crossed (often will be the outside polygon)
