...
namespace cxutil
{
MergeInfillLines::MergeInfillLines(ExtruderPlan& plan, coord_t _nozzle_size, coord_t _maximum_deviation)
: extruder_plan(plan)
, nozzle_size(_nozzle_size)
, maximum_deviation(_maximum_deviation)
    {
