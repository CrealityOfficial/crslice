...
public:
    ...
    ZSeamConfig(EZSeamType type, Point pos, EZSeamCornerPrefType corner_pref, float z_seam_min_angle_diff, float z_seam_max_angle)
    : type(type)
    , pos(pos)
    , corner_pref(corner_pref)
    , z_seam_min_angle_diff(z_seam_min_angle_diff)
    , z_seam_max_angle(z_seam_max_angle)
    {
    }
};
