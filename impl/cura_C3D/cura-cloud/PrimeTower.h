...
#include "cxutil/math/polygon.h" // Polygons
...
private:
    ...
    unsigned int number_of_prime_tower_start_locations = 21; //!< The required size of \ref PrimeTower::wipe_locations
