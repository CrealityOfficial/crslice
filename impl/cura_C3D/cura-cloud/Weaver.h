...
public:
     ...
     */
    void weave(MeshGroup* objects, Scene* scene);
 ...
 */
    void connect(Polygons& parts0, int z0, Polygons& parts1, int z1, WeaveConnection& result, Scene* scene);
 ...
 */
    void chainify_polygons(Polygons& parts1, Point start_close_to, Polygons& result, Scene* scene);
 ...
 */
    void createHorizontalFill(WeaveLayer& layer, Polygons& layer_above, Scene* scene);
 ...
 * 
 */
    void fillRoofs(Polygons& supporting, Polygons& to_be_supported, int direction, int z, WeaveRoof& roofs, Scene* scene);
 ...
 * 
 */
    void fillFloors(Polygons& supporting, Polygons& to_be_supported, int direction, int z, WeaveRoof& roofs, Scene* scene);
    
/*!
 * Filter out parts of connections with small distances; replace by moves.
 * 
 */
    void connections2moves(WeaveRoofPart& inset, Scene* scene);
