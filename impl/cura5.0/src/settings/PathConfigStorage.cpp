...
, bridge_inset0_config(
    ...
    , true // is_bridge_path
    , mesh.settings.get<bool>("cool_fan_enabled") ? (double)mesh.settings.get<Ratio>("bridge_fan_speed") * 100.0 : GCodePathConfig::FAN_SPEED_DEFAULT
)
...
, bridge_skin_config2( // use bridge skin 2 flow, speed and fan
    ...
    , true // is_bridge_path
    , mesh.settings.get<bool>("cool_fan_enabled") ? (double)mesh.settings.get<Ratio>("bridge_fan_speed_2") * 100.0 : GCodePathConfig::FAN_SPEED_DEFAULT
)
, bridge_skin_config3( // use bridge skin 3 flow, speed and fan
    ...
    , true // is_bridge_path
    , mesh.settings.get<bool>("cool_fan_enabled") ? (double)mesh.settings.get<Ratio>("bridge_fan_speed_3") * 100.0 : GCodePathConfig::FAN_SPEED_DEFAULT
)
, roofing_config(
    PrintFeatureType::Skin
