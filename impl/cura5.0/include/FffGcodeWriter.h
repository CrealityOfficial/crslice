...
public:
    ...
    */
    bool processEstimatePoints(const Polygons& prev_paths, const Polygons& cur_paths, const float layer_width,std::vector<std::vector<Slic3r::ExtendedPoint>>& extendedPoints);
private:
    /*!
