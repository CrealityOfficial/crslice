...
public:
    ...
    static Polygons generateWallToolPathsT(std::vector<VariableWidthLines>& toolpaths, Polygons& outer_contour, const size_t wall_line_count, const coord_t line_width, const coord_t infill_overlap, const Settings& settings, int layer_idx, cura54::SectionType section_type);
private:
    /*!
