...
__files_group(${CMAKE_CURRENT_LIST_DIR}/include/ engine1)
__files_group(${CMAKE_CURRENT_LIST_DIR}/src/ engine2)

list(APPEND SRCS ${engine2} ${engine1})
...
list(APPEND INCS ${CMAKE_CURRENT_LIST_DIR}/src)
