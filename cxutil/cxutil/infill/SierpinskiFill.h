...
namespace cxutil
{
    ...
    public:
         ...
         */
        cxutil::Polygon generateCross() const;

        /*!
         * Generate the Sierpinski space filling curve
         */
        cxutil::Polygon generateCross(coord_t z, coord_t min_dist_to_side, coord_t pocket_size) const;
    ...
    protected:
        ...
        cxutil::AABB aabb; //!< The square which is the basis of the subdivision of the area on which the curve is based.
