...
namespace cxutil
{
    ...
    protected:
        ...
        struct FractalConfig
        {
            ...
            cxutil::AABB aabb; //!< The bounding box of the initial Triangles in the Sierpinski curve
        };
    public:
        ...
        cxutil::optional<SierpinskiFill> fill_pattern_for_all_layers; //!< The fill pattern if one and the same pattern is used on all layers
        ...
        cxutil::Polygon generate(EFillMethod pattern, coord_t z, coord_t line_width, coord_t pocket_size) const;
