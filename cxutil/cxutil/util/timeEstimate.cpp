...
#define MINIMUM_PLANNER_SPEED 0.05 // mm/sec
    ...
    void TimeEstimateCalculator::setFirmwareDefaults(const TimeEstimateParam& param)
    {
        max_feedrate[X_AXIS] = param.machine_max_feedrate_x;
        max_feedrate[Y_AXIS] = param.machine_max_feedrate_y;
        max_feedrate[Z_AXIS] = param.machine_max_feedrate_z;
        max_feedrate[E_AXIS] = param.machine_max_feedrate_e;
        max_acceleration[X_AXIS] = param.machine_max_acceleration_x;
        max_acceleration[Y_AXIS] = param.machine_max_acceleration_y;
        max_acceleration[Z_AXIS] = param.machine_max_acceleration_z;
        max_acceleration[E_AXIS] = param.machine_max_acceleration_e;
        max_xy_jerk = param.machine_max_jerk_xy;
        max_z_jerk = param.machine_max_jerk_z;
        max_e_jerk = param.machine_max_jerk_e;
        minimumfeedrate = param.machine_minimum_feedrate;
        acceleration = param.machine_acceleration;
    }
