...
#include "cxutil/util/SparseLineGrid.h"
...
{
    template <>
    struct hash<cxutil::ClosestPolygonPoint>
    {
        size_t operator()(const cxutil::ClosestPolygonPoint& cpp) const
        {
            return std::hash<cxutil::Point>()(cpp.p());
        }
    };
}//namespace std
...
namespace cxutil
{
    ...
    public:
        ...
        */
         ...
         */
        static cxutil::optional<ClosestPolygonPoint> findClose(Point from, const Polygons& polygons, const LocToLineGrid& loc_to_line, const std::function<int(Point)>& penalty_function = no_penalty_function);
        ...
        */
         ...
         */
        static cxutil::optional<ClosestPolygonPoint> getNextParallelIntersection(const ClosestPolygonPoint& start, const Point& line_to, const coord_t dist, const bool forward);
