...
namespace cxutil
{
    ...
    private:
        ...
        cxutil::optional<int> to_be_consumed_item_idx; //!< The index into \ref GcodeLayerThreader::produced where to find the next item ready to be consumed (if any)
...
#pragma omp critical
        ...
        {
            cxutil::optional<int> item_argument_index;
#pragma omp critical
            {
