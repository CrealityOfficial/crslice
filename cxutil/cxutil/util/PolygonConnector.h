...
namespace cxutil
{
    ...
    protected:
         ...
         */
        cxutil::optional<PolygonBridge> getBridge(ConstPolygonRef poly, std::vector<Polygon>& polygons);
         ...
         */
        cxutil::optional<PolygonConnection> getSecondConnection(PolygonConnection& first);
    };
